                    ...
                    <v-table theme="dark" class="month-table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-h6 text-no-wrap">Project Name</th>
                                <th class="text-h6 text-no-wrap">Team</th>
                                <th class="text-h6 text-no-wrap">Status</th>
                                <th class="text-h6 text-no-wrap">Budget</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="item in darkTableData" :key="item.name" class="month-item">
                                <td>
                                    <div class="d-flex align-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-subtitle-1 text-medium-emphasis text-no-wrap">{{ item.post }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <h6 class="text-h6 text-no-wrap">{{ item.budget }}</h6>
                                </td>
                            </tr>
                        </tbody>
                    </v-table>
