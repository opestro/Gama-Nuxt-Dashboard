    ...
    <v-col cols="12" md="4" sm="6" v-for="card in pricing" :key="card.caption">
      <v-card elevation="10" class="rounded-md pa-sm-8 pa-4">
        <div class="d-flex justify-space-between">
          <h4
            class="text-body-2 text-medium-emphasis text-uppercase mb-6"
            v-text="card.caption"
          ></h4>
          <v-chip
            v-if="card.tagtext"
        ...
        <div v-else class="d-flex align-center mt-4">
          ...
          <span
            ...
            >/yr</span
          >
          <span v-else class="text-medium-emphasis font-weight-medium mt-4 ml-2"
            >/mo</span
          >
        </div>
        ...
        <v-btn color="primary" size="large" class="mt-6" flat block>{{
          card.buttontext
        }}</v-btn>
      </v-card>
    </v-col>
